 ...
 *
 * <p>本类用最朴素的 {@code @Configuration} + {@code @ComponentScan},
 * 不被 Spring Boot Test 当作候选主类,对其它上下文零影响.
 *
 * <p>数据源由 {@link McpDataSourceConfig} 通过 {@code Environment} 读取
 * {@code application.yml} 中的 {@code spring.datasource.*} 参数创建,
 * 不依赖 Spring Boot 自动配置.
